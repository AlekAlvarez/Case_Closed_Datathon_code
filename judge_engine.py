...
def main():
    for i in range(100):
        ...
        if i%2==0:
            ...
            PLAYER1_URL = os.getenv("PLAYER1_URL", "http://localhost:5009")
            PLAYER2_URL = os.getenv("PLAYER2_URL", "http://localhost:5008")
        ...
        while True:
            ...
            if result is not None:
                ...
                s=3
                #print(status)
                if(GameResult.AGENT1_WIN==status):
                    s=1
                elif(status==GameResult.AGENT2_WIN):
                    s=2
                else:
                    s=3
                if s==i%2+1:
